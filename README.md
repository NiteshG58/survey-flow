...
| **Research Defender / Verisoul (Optional Security)** | Conditional calls to external fraud‑prevention services – only executed if enabled in `Environment`. | `SurveyService.researchDfdFunction`, `SurveyService.verisoulFunction` |
